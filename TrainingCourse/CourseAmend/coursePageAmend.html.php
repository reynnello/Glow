...
<header class="topbar">
    <a class="brand" href="../../mainPage.html.php" aria-label="Go to Main Page">
        ...
        <div class="brand-text">
            ...
            <div class="brand-subtitle">Amend/View Course</div>
        </div>
    </a>
...
<main class="page">
    <section class="card">
        <h1>Amend/View Page</h1>
        <p class="hint">
            Please select a course and then click the "Amend details" button to enable fields editing.
        </p>
        ...
        <form name="myForm" action="coursePagePost.php" onsubmit="return confirmCheck()" method="post">
            ...
            <div class="field">
                ...
                <input type="number" name="delId" id="delId" disabled>
            </div>

            <div class="field">
                <label for="delTitle">Course Title</label>
                <input type="text" name="delTitle" id="delTitle" disabled>
            </div>

            <div class="field">
                <label for="delProvider">Course Provider</label>
                <input type="text" name="delProvider" id="delProvider" disabled>
            </div>
            ...
            <div class="field">
                ...
                <input type="text" name="delFee" id="delFee" disabled>
            </div>

            <div class="field">
                <label for="delVenue">Course Venue</label>
                <input type="text" name="delVenue" id="delVenue" disabled>
            </div>

            <div class="field">
                <label for="delPlaces">Course Total Places</label>
                <input type="text" name="delPlaces" id="delPlaces" disabled>
            </div>

            <div class="field">
                <label for="delLeftPlaces">Course Places Left</label>
                <input type="text" name="delLeftPlaces" id="delLeftPlaces" disabled>
            </div>

            <div class="field">
                <label for="delStartDate">Start Date</label>
                <input type="text" name="delStartDate" id="delStartDate" disabled>
            </div>

            <div class="field">
                <label for="delNumberOfDays">Course Number Of Days</label>
                <input type="text" name="delNumberOfDays" id="delNumberOfDays" disabled>
            </div>

            <div class="field">
                <label for="delStartTime">Course Start Time</label>
                <input type="text" name="delStartTime" id="delStartTime" disabled>
            </div>

            <div class="field">
                <label for="delEndTime">Course End Time</label>
                <input type="text" name="delEndTime" id="delEndTime" disabled>
            </div>
    ...
    <section class="info">
        <div class="info-card">
            <h2>How it works</h2>
            <p>
                Click <b>"Amend details"</b> to set fields editable. Then press <b>"Save Changes"</b>
            </p>
        </div>
...
<script>
    ...
    function toggleLock()//function that unlock/locks the data and changes the button depending on the button state
    {
        ...
        else
        {
            ...
            document.getElementById("delTitle").disabled = true;
            document.getElementById("delProvider").disabled = true;
            document.getElementById("delDescription").disabled = true;
            document.getElementById("delFee").disabled = true;
            document.getElementById("delVenue").disabled = true;
            document.getElementById("delPlaces").disabled = true;
            document.getElementById("delLeftPlaces").disabled = true;
            document.getElementById("delStartDate").disabled = true;
            document.getElementById("delNumberOfDays").disabled = true;
            document.getElementById("delStartTime").disabled = true;
            document.getElementById("delEndTime").disabled = true;
    ...
    function confirmCheck()
    {
        ...
        var response = confirm('Are you sure you want to save the record "' + courseTitle + '" record from the list?');
